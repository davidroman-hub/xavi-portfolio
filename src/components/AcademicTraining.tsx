      ...
      <div className="container">
            ...
            {academicData.map((item, index) => (
              <div key={item.id} className={`timeline-item ${index % 2 === 0 ? 'left' : 'right'}`}>
                <div className="timeline-marker">
                  <img src={item.logo} alt={item.institution} className="institution-logo" />
                </div>
        ...
        <div className="professional-profile">
          <div className="profile-header">
            ...
            <p className="profile-description">{t('academic.profile.description')}</p>
          </div>
          
          <div className="profile-content">
            <div className="profile-image">
              <img src={professionalPhoto} alt={t('academic.profile.professional')} />
